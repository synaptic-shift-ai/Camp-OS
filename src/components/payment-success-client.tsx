    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">Welcome to CampOS</p>
        </motion.div>
          ...
          <Card className="bg-card border-border p-6 mb-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-foreground font-semibold">{plan.bookingsIncluded} bookings/month</p>
              </div>
            </div>
          </Card>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <Alert className="bg-blue-500/10 border-blue-500/20 mb-6">
            ...
            <AlertDescription className="text-foreground/80 ml-2">
              ...
              {email ? (
                <p className="font-mono text-foreground mb-2">{email}</p>
              ) : null}
              ...
              <Link
                href="/onboarding"
                className="text-sm font-medium text-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors underline"
              >
                Go to onboarding →
              </Link>
            </AlertDescription>
          ...
          <Card className="bg-card border-border p-6 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-6">
                  <p className="text-foreground font-medium mb-1">Account created</p>
                  <p className="text-sm text-muted-foreground">Your CampOS account is active</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-6">
                  <p className="text-foreground font-medium mb-1">Payment confirmed</p>
                  <p className="text-sm text-muted-foreground">Subscription started successfully</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-6">
                  <p className="text-foreground font-medium mb-1">Set up your property</p>
                  <p className="text-sm text-muted-foreground">Add property details and upload photos (2 min)</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-6">
                  <p className="text-foreground font-medium mb-1">Add campsites</p>
                  <p className="text-sm text-muted-foreground">Create your sites and set pricing (5 min)</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-foreground font-medium mb-1">Connect Stripe</p>
                  <p className="text-sm text-muted-foreground">Link your Stripe account for payouts (3 min)</p>
                </div>
              </div>
            </div>
          </Card>
        ...
        >
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/docs/getting-started" className="text-sm text-primary hover:text-primary/80 transition-colors">
              View setup guide
            </Link>
          </div>
        </motion.div>
