...
import type { AddChecklistTemplateInput } from "./add-checklist-dialog"

export type EditChecklistTemplateInput = AddChecklistTemplateInput & {
  checklistId: string
}
...
type EditChecklistDialogProps = {
  ...
  onSubmit: (input: EditChecklistTemplateInput) => Promise<void>
}
      ...
      <DialogContent className="max-w-2xl gap-0 p-0 sm:max-w-2xl">
        <DialogHeader className="space-y-1 border-b border-border px-6 py-4 text-left">
          ...
          <DialogDescription className="sr-only">
            Update this checklist template name, description, and line items.
          </DialogDescription>
        </DialogHeader>
