          ...
          {([1, 2, 3, 4, 5] as Step[]).map((s) => (
            <div
              ...
              className={cn(
                ...
                s <= step
                  ? "bg-[hsl(0,84.2%,60.2%)] dark:bg-[hsl(0,72%,51%)]"
                ...
                {([
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      form.channel === ch.value
                        ? "border-[hsl(0,84.2%,60.2%)] bg-red-50 dark:border-[hsl(0,72%,51%)] dark:bg-red-950/30"
                  ...
                  >
                    <ch.icon className={cn(
                      "h-6 w-6",
                      form.channel === ch.value
                        ? "text-[hsl(0,84.2%,60.2%)] dark:text-red-400"
            ...
            {loading ? (
              ...
              <>
                <div className={cn(CARD, "flex items-center gap-4")}>
                  <Users className="h-6 w-6 text-[hsl(0,84.2%,60.2%)] dark:text-red-400" aria-hidden />
                  <div>
