...
import { SmsTemplateEditorPage } from '@/components/dashboard/automations/sms-template-editor-page'
...
export default async function EditSmsTemplatePage({
  ...
  const permissionKey: PermissionKey = 'automations.edit_sms_templates'
  ...
  if (!template || (companyId && template.company_id !== companyId)) {
    redirect(`/dashboard/${propertyId}/automations?tab=sms-templates`)
  }
