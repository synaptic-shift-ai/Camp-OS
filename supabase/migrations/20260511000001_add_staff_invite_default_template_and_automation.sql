-- Migration: Add staff_invite default email template + default automation
-- Description: Adds a managed email template and automation for staff invitations,
...
-- ============================================================================
-- A. Insert staff_invite into default_email_templates (idempotent upsert)
-- ============================================================================
...
-- ============================================================================
-- B. Insert staff.invited default automation (idempotent upsert on trigger_type)
-- ============================================================================

INSERT INTO public.default_automations (name, description, phase, scope, trigger_type, sort_order, actions, is_active)
VALUES (
  'Staff Invitation Email',
  'Sends an invitation email when a staff member is invited to join a property',
  'COMMUNICATE',
  'property',
  'staff.invited',
  8,
  '[{"action_type":"send_email","action_config":{"template":"staff_invite","recipient_source":"staff"},"sort_order":0}]'::jsonb,
  true
)
...
-- ============================================================================
-- C. Backfill existing companies with the new staff_invite template
-- ============================================================================
...
-- ============================================================================
-- D. Backfill existing properties with the new staff.invited automation
-- ============================================================================
...
WITH inserted_automations AS (
  ...
  WHERE da.trigger_type = 'staff.invited'
