 ...
 * Covers 200+ standard IANA timezones grouped by region.
 * Returns null for UTC/GMT meta-zones with no country.
 */
...
const timezoneToCountry: Record<string, string> = {
  ...
  // ── US (link targets that may appear via Intl API) ──────────
  'US/Alaska': 'US',
  'US/Aleutian': 'US',
  'US/Arizona': 'US',
  'US/Central': 'US',
...
// Timezones that have no country — return null
const noCountryTimezones = new Set([
  'UTC',
  'Greenwich',
  'Zulu',
  'Etc/UTC',
...
/**
 * Map an IANA timezone string to an ISO 3166-1 alpha-2 country code.
 * Returns null if the timezone has no country (e.g., UTC, Etc/GMT*).
 */
export function getTimezoneCountry(timezone: string): string | null {
  if (noCountryTimezones.has(timezone)) return null;
