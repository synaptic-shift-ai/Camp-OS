...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      error(ERROR_CODES.INTERNAL_ERROR, 'Failed to fetch property', {
        message: err.message,
      }),
      { status: 500 }
    )
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json(
      error(ERROR_CODES.INTERNAL_ERROR, 'Failed to update property', {
        message: err.message,
      }),
      { status: 500 }
    )
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      error(ERROR_CODES.INTERNAL_ERROR, 'Failed to delete property', {
        message: err.message,
      }),
      { status: 500 }
    )
