      ...
      <div className="container flex flex-col gap-10 py-16">
        <div className="flex flex-col gap-10 md:flex-row">
          <div className="flex flex-1 flex-col gap-4">
            ...
            <p className="text-muted-foreground max-w-sm opacity-70">
              Modern property management software for campgrounds, RV parks, and glamping sites. Streamline operations
              and create unforgettable guest experiences.
            </p>
          ...
          <div className="grid flex-1 grid-cols-2 gap-10 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-sm font-medium tracking-tight">Resources</h3>
              <ul className="flex flex-col gap-2">
                <li>
                  <Link
                    href="#blog"
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-muted-foreground opacity-70">
            &copy; {new Date().getFullYear()} CampOS. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link
              href="#terms"
