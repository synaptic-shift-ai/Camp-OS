            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between border-b border-border pb-3 last:border-0">
                  <div>
                    <p className="font-medium">Site {i * 5}</p>
                    <p className="text-sm text-muted-foreground">John Doe • 3 nights</p>
                  </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between border-b border-border pb-3 last:border-0">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Site {i * 3} • Today 3:00 PM</p>
                  </div>
                  <div className="text-right">
