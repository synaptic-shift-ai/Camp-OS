...
export function GuestFilters({ propertyId, siteTypes, allowedSiteTypes }: GuestFiltersProps) {
  ...
  }, [mobileFiltersOpen, currentSiteType, currentSortBy, currentSortOrder])
  ...
  return (
    <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-2 xl:flex-row xl:items-end xl:gap-2">
              ...
              <Dialog open={mobileFiltersOpen} onOpenChange={setMobileFiltersOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>Site, sort, and order controls.</DialogDescription>
                  </DialogHeader>
