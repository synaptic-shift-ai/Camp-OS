  ...
  return (
    <>
      ...
      <Table className="w-full table-fixed">
        ...
        <TableHeader>
          <TableRow className="border-b border-border/80 hover:bg-transparent data-[state=selected]:bg-transparent">
            <TableHead className="h-11 px-4 py-3 text-left text-xs font-medium text-muted-foreground">Name</TableHead>
            <TableHead className="h-11 px-4 py-3 text-left text-xs font-medium text-muted-foreground">
              Description
            </TableHead>
            <TableHead className="h-11 px-3 py-3 text-right text-xs font-medium text-muted-foreground">Items</TableHead>
            <TableHead className="h-11 px-3 py-3 text-right text-xs font-medium text-muted-foreground">Created</TableHead>
            <TableHead className="h-11 px-3 py-3 text-right text-xs font-medium text-muted-foreground">Actions</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {rows.map((row) => {
            ...
            return (
              <TableRow
                key={row.id}
                className="border-b border-border/80 last:border-0 hover:bg-muted/20 data-[state=selected]:bg-transparent"
              >
                ...
                <TableCell className="px-3 py-4 text-right align-middle text-sm tabular-nums text-muted-foreground">
                  {itemCount}
                </TableCell>
                <TableCell className="px-3 py-4 text-right align-middle text-sm text-muted-foreground whitespace-nowrap">
                  {createdLabel}
                </TableCell>
