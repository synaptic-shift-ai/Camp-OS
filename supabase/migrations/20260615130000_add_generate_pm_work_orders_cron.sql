-- ============================================================
-- Add generate-pm-work-orders cron job
-- ============================================================
-- Registers POST /api/cron/generate-pm-work-orders daily at 06:00 UTC.
-- Creates preventive maintenance work orders for due schedules.
--
...
BEGIN
  ...
  -- Generate PM Work Orders — daily at 06:00 UTC
  PERFORM cron.schedule(
