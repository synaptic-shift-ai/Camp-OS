...
type EmailTemplateVariablePanelProps = {
...
export function EmailTemplateVariablePanel({
  onInsert,
  activeField,
  onAfterInsert,
  className,
}: EmailTemplateVariablePanelProps) {
  const [search, setSearch] = useState("")
  const panelRef = useRef<HTMLDivElement>(null)
  const copyClickTimeoutRef = useRef<ReturnType<typeof setTimeout> | null>(
    null
  )
